...
// Cfits_read_img
SEXP Cfits_read_img(Rcpp::String filename, int ext, int datatype, long naxis1, long naxis2, long naxis3, long naxis4, int nthreads);
RcppExport SEXP _Rfits_Cfits_read_img(SEXP filenameSEXP, SEXP extSEXP, SEXP datatypeSEXP, SEXP naxis1SEXP, SEXP naxis2SEXP, SEXP naxis3SEXP, SEXP naxis4SEXP, SEXP nthreadsSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< Rcpp::String >::type filename(filenameSEXP);
    ...
    rcpp_result_gen = Rcpp::wrap(Cfits_read_img(filename, ext, datatype, naxis1, naxis2, naxis3, naxis4, nthreads));
    return rcpp_result_gen;
END_RCPP
}
// Cfits_read_header
...
// Cfits_read_img_omp
SEXP Cfits_read_img_omp(Rcpp::String filename, int ext, int datatype, long naxis1, long naxis2, long naxis3, long naxis4, int nthreads);
RcppExport SEXP _Rfits_Cfits_read_img_omp(SEXP filenameSEXP, SEXP extSEXP, SEXP datatypeSEXP, SEXP naxis1SEXP, SEXP naxis2SEXP, SEXP naxis3SEXP, SEXP naxis4SEXP, SEXP nthreadsSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< Rcpp::String >::type filename(filenameSEXP);
    ...
    Rcpp::traits::input_parameter< long >::type naxis4(naxis4SEXP);
    Rcpp::traits::input_parameter< int >::type nthreads(nthreadsSEXP);
    rcpp_result_gen = Rcpp::wrap(Cfits_read_img_omp(filename, ext, datatype, naxis1, naxis2, naxis3, naxis4, nthreads));
    return rcpp_result_gen;
END_RCPP
}
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_Rfits_Cfits_read_img", (DL_FUNC) &_Rfits_Cfits_read_img, 8},
    ...
    {"_Rfits_Cfits_read_img_omp", (DL_FUNC) &_Rfits_Cfits_read_img_omp, 8},
    {NULL, NULL, 0}
};
