...
Cfits_write_image <- function(filename, data, datatype, naxis, naxis1, naxis2, naxis3 = 1L, ext = 1L, create_ext = 1L, create_file = 1L, bitpix = 32L) {
    invisible(.Call(`_Rfits_Cfits_write_image`, filename, data, datatype, naxis, naxis1, naxis2, naxis3, ext, create_ext, create_file, bitpix))
}
